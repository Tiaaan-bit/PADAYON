...
<aside class="hidden lg:flex fixed top-0 left-0 h-screen w-64 bg-[#849753] flex-col z-50">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('user.therapists.index') }}"
            ...
            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"> <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8z" /> </svg>
            Therapists
        </a>
