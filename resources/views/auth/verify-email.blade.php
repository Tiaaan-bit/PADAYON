    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl p-8 mx-auto">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-amber-100 rounded-full mb-4">
                <svg class="w-9 h-9 text-[#849753]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div class="flex items-center justify-center mb-6">
            <span class="inline-flex items-center gap-2 px-4 py-2 bg-yellow-50 border border-yellow-200 text-yellow-700 text-sm font-medium rounded-full">
