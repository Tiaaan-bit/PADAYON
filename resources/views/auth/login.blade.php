...
<body class="min-h-screen bg-[#D6BB9E] flex items-center justify-center p-4">
    ...
    @if (session('login_rate_limited'))
        <div id="rateLimitModal"
            ...
            <div class="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl p-7 text-center">
                ...
                <div class="mt-6">
                    ...
                    <div id="rateLimitTimer" class="mt-2 text-5xl font-bold text-[#849753] tabular-nums">
                        10:00
                    </div>
                </div>
                ...
                <div class="mt-6 h-2 w-full overflow-hidden rounded-full bg-gray-200">
                    <div id="rateLimitProgress" class="h-full bg-[#849753] transition-all duration-1000"
                        style="width: 100%"></div>
                </div>
